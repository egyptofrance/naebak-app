...
import { User, MapPin, Briefcase, Vote, Award } from 'lucide-react'
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .update({
          ...
          account_status: 'pending', // MPs need admin approval
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            استكمال البيانات - نائب برلماني
          </h1>
          <p className="text-gray-600">
            يرجى ملء البيانات التالية لإكمال ملفك الشخصي كنائب في البرلمان المصري
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                معلومات خاصة بالعملية الانتخابية والبرلمانية
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
          ...
          <Card className="bg-blue-50 border-blue-200">
            ...
            <CardContent>
              ...
              <ul className="list-disc list-inside text-blue-700 text-sm mt-2 space-y-1">
                ...
                <li>الإنجازات البرلمانية</li>
                <li>المناسبات والفعاليات</li>
                <li>التواصل مع المواطنين</li>
              </ul>
              <p className="text-blue-700 text-sm mt-3">
                سيتم مراجعة بياناتك من قبل فريق الإدارة للتأكد من صحتها قبل تفعيل الحساب.
              </p>
            </CardContent>
          </Card>
